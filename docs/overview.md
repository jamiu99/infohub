...
最后更新：**2026-07-13** · 阶段：**v0.1.3 桌面桥接修复与稳定化**
...
| 当前源码版本 | `v0.1.3`；本文件所在提交为发布基线 |
| 上个正式版本 | `v0.1.1`（提交 `642a8d6`，2026-07-12）；`v0.1.2` 已撤回 |
| 自动检查 | `pnpm typecheck` ✅ · `pnpm test:core` ✅（37/37）· `pnpm build` ✅ |
...
- ⬜ 在 Windows 人工安装 `v0.1.3`，验收二维码、RSS、阅读、归档、图片和外链。
- ⬜ 从已安装的 `v0.1.1` 自动更新到 `v0.1.3`，确认重启安装和旧数据迁移。
...
1. 安装 `v0.1.3`，完成 Windows IPC、二维码和跨版本更新验收。
