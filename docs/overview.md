...
最后更新：**2026-07-15** · 阶段：**v0.3.1 发布：Windows 安装包统一项目品牌图标**
...
| 当前源码版本 | `v0.3.1` |
| 上个正式版本 | `v0.3.0`（2026-07-15）；`v0.1.2` 已撤回 |
...
- ⬜ 在 Windows 人工安装 `v0.3.1`，验收项目图标、二维码、配额、RSS、原始排版/阅读版、归档、三栏布局、团队加入和“我的 / 团队”。
- ⬜ 在团队服务端先升级后，从已安装的 `v0.2.1` 按确认式流程更新到 `v0.3.1`，确认重启安装、设置、布局、账号数据和 HTML sidecar 保留。
...
2. 先升级配套团队服务端，再用两台 Windows 设备完成 v0.2.1 → v0.3.1 更新与团队 HTML 同步验收。
