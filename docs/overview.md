...
最后更新：**2026-07-13** · 阶段：**v0.1.2 登录修复与稳定化**
...
| 当前源码版本 | `v0.1.2`；本文件所在提交为发布基线 |
| 上个发布版本 | `v0.1.1`（提交 `642a8d6`，2026-07-12） |
...
- ⬜ 在 Windows 人工安装 `v0.1.2`，验收二维码、RSS、阅读、归档、图片和外链。
- ⬜ 从已安装的 `v0.1.1` 自动更新到 `v0.1.2`，确认重启安装和旧数据迁移。
...
1. 安装 `v0.1.2`，完成 Windows 二维码和跨版本更新验收。
