...
最后更新：**2026-07-13** · 阶段：**v0.1.4 更新体验与稳定化**
...
| 当前源码版本 | `v0.1.4`；本文件所在提交为发布基线 |
| 上个正式版本 | `v0.1.3`（提交 `ed3c66d`，2026-07-13）；`v0.1.2` 已撤回 |
| 自动检查 | `pnpm typecheck` ✅ · `pnpm test:core` ✅（42/42）· `pnpm build` ✅ |
...
- ⬜ 在 Windows 人工安装 `v0.1.4`，验收二维码、RSS、阅读、归档、图片和外链。
- ⬜ 从已安装的 `v0.1.3` 按确认式流程更新到 `v0.1.4`，确认重启安装和数据保留。
...
1. 先用 `v0.1.3` 恢复当前安装，再按提示升级 `v0.1.4`，验收完整更新流程。
